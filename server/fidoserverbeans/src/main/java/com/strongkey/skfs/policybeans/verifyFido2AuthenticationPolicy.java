...
//        FidoKeys fk = getfidokeysbean.getByfkid(userInfo.getSkid(), did, userInfo.getUsername(), userInfo.getFkid());
        ...
        //Verify Counter
        verifyCounter(fidoPolicy.getCounterRequirement(), clientJson, authData, signingKey, fidoPolicy.getVersion());
    ...
    private void verifyCounter(String counterRequire, JsonObject clientJson,
            FIDO2AuthenticatorData authData, FidoKeys signingKey, String version) throws SKFEException {
        ...
        if(counterRequire.equals("mandatory")){
