...
public class FidoAdminServlet {
   ...
   private getFidoPolicyLocal lookupgetFidoPolicyLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (getFidoPolicyLocal) c.lookup("java:app/fidoserverbeans-4.3.0/getFidoPolicy!com.strongkey.skfs.policybeans.getFidoPolicyLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
   private deleteFidoPolicyLocal lookupdeleteFidoPolicyLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (deleteFidoPolicyLocal) c.lookup("java:app/fidoserverbeans-4.3.0/deleteFidoPolicy!com.strongkey.skfs.policybeans.deleteFidoPolicyLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
    ...
    private updateFidoPolicyLocal lookupActionFidoPolicyLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (updateFidoPolicyLocal) c.lookup("java:app/fidoserverbeans-4.3.0/updateFidoPolicy!com.strongkey.skfs.policybeans.updateFidoPolicyLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
    ...
    private addFidoPolicyLocal lookupaddFidoPolicyLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (addFidoPolicyLocal) c.lookup("java:app/fidoserverbeans-4.3.0/addFidoPolicy!com.strongkey.skfs.policybeans.addFidoPolicyLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
    ...
    private updateFIDOConfigurationLocal lookupupdateFidoConfigLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (updateFIDOConfigurationLocal) c.lookup("java:app/fidoserverbeans-4.3.0/updateFIDOConfiguration!com.strongkey.skfs.txbeans.updateFIDOConfigurationLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
    ...
    private getAllConfigurationsBeanLocal lookupgetAllFidoConfigLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (getAllConfigurationsBeanLocal) c.lookup("java:app/fidoserverbeans-4.3.0/getAllConfigurationsBean!com.strongkey.skfs.txbeans.getAllConfigurationsBeanLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
    private deleteFIDOConfigurationsLocal lookupdeleteFidoConfigLocal() {
        try {
            javax.naming.Context c = new InitialContext();
            return (deleteFIDOConfigurationsLocal) c.lookup("java:app/fidoserverbeans-4.3.0/deleteFIDOConfigurations!com.strongkey.skfs.txbeans.deleteFIDOConfigurationsLocal");
        } catch (NamingException ne) {
            throw new RuntimeException(ne);
        }
    }
